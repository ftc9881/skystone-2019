...
public class CustomSkystoneDetector extends DogeCVDetector {
    ...
    public void setLookWindow (Rect rect) {
        lookWindow = rect;
    }
    ...
    public Mat process(Mat input) {
        ...
        // CUSTOM
        Point bestRectCenter = new Point(bestRect.x + bestRect.width/2, bestRect.y + bestRect.height/2);
        boolean isInWindow = lookWindow.contains(bestRectCenter);
